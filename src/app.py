...
#GET USERS// Este sera el endpoint para poder obtener todos los usuarios en la API
...
#CREATE USER // Este sera el endpoint que nos permitira creat un nuevo usuario 
...
# GET PEOPLE / CHARACTER: Este sera el endpoint para obtener la info de los characters
